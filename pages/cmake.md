...
<package format="3">
  <name>simple_cpp_python_publish_subscribe</name>
...
## Package using a custom message
...
```cmake
cmake_minimum_required(VERSION 3.8)
project(package_using_custom_msgs)
...
<?xml-model href="http://download.ros.org/schema/package_format3.xsd" schematypens="http://www.w3.org/2001/XMLSchema"?>
<package format="3">
  <name>package_using_custom_msgs</name>
  <version>0.0.0</version>
  <description>TODO: Package description</description>
  <maintainer email="rueda_999@hotmail.com">pep248</maintainer>
  <license>TODO: License declaration</license>
  ...
  <depend>rclcpp</depend>
  <depend>rclpy</depend>
  <depend>calibration_msgs</depend>
